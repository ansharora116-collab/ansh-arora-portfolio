...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Without an endpoint there is nowhere to deliver the message, so hand the
    // visitor off to email rather than pretending it was sent.
          ...
          >
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {error && (
                  <p
                    className="text-[11px] text-[#E0A0A0] tracking-wide"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    {error}
                  </p>
